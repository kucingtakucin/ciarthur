            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="row chat-box">
                        ...
                        <div class="col pr-3 pl-3 chat-right-aside">
                        <!-- chat start-->
                            <div class="chat">
                                <!-- chat-header start-->
                                <div class="chat-header clearfix"><img class="rounded-circle" src="https://upload.wikimedia.org/wikipedia/commons/0/0a/Gnome-stock_person.svg" alt="">
                                    <div class="about">
                                ...
                                <div class="chat-history chat-msg-box custom-scrollbar">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="message my-message mb-0"><img class="rounded-circle float-left chat-user-img img-30" src="https://upload.wikimedia.org/wikipedia/commons/0/0a/Gnome-stock_person.svg" alt="">
