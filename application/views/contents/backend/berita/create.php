<div class="card">
	<div class="card-body">
		<h3 class="text-center">Tambah Data Berita</h5>
		...
		<form id="form_tambah" enctype="multipart/form-data">
			<div class="row">
				<div class="col-md-8">
					...
					<div class="form-group">
						<label for="input_tambah_konten">Konten</label>
						<textarea name="konten" id="input_tambah_konten" class="form-control tinymce"></textarea>
				...
				<div class="col-md-4">
					<div class="card">
						...
						<div class="card-body pt-3 pb-3 pr-3 pl-3">
							<select name="kategori_id" id="select_tambah_kategori_id" class="form-control">
								<option></option>
							</select>
							<?= validation_feedback('tambah', 'kategori_id') ?>
						</div>
					</div>
					...
					<div class="card">
						...
						<div class="card-body pt-3 pb-3 pr-3 pl-3">
							<select name="tags[]" multiple id="select_tambah_tags" class="form-control">
								<option></option>
							</select>
							<?= validation_feedback('tambah', 'tag') ?>
						</div>
					</div>
								...
								<div class="col-sm-12">
									<div class="input-group">
										<div class="custom-file">
											<input type="file" id="input_tambah_gambar" name="gambar" class="form-control">
