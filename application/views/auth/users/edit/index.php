	...
	<div class="card-body">
		<form id="update_user" class="needs-validation" onsubmit="$update_user(event,'<?= $user->uuid ?>')" novalidate>
			...
			<div class="form-group">
				...
				<?= form_input($first_name, '', 'class="form-control" required autocomplete="off" required autocomplete="off"'); ?>
			...
			<div class="form-group">
				...
				<?= form_input($password, '', 'class="form-control" autocomplete="off" minlength="8"'); ?>
			...
			<div class="form-group">
				...
				<?= form_input($password_confirm, '', 'class="form-control" autocomplete="off" minlength="8"'); ?>
			...
			<div class="form-group mt-3">
				...
				<?= form_submit('submit', lang('edit_user_submit_btn'), 'class="btn btn-primary btn-pill"'); ?>
