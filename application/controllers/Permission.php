...
class Permission extends MY_Controller
{
    ...
    public function permissions()
    {
        ...
        $this->load->view('auth/permission/permissions', $data);
    }
    ...
    public function delete_permission()
    {
        ...
        if ($this->input->post() && $this->input->post('delete')) {
            ...
            $this->load->view('auth/permission/delete_permission', $data);
        }
    }
    ...
    {
        if ($this->input->post() && $this->input->post('cancel'))
            redirect('/permission/groups', 'refresh');
        ...
        $this->load->view('auth/permission/group_permissions', $data);
    }
