...
class Datatable extends CI_Model
{
	...
	private $_column_order = [null, 'a.judul', 'nama_kategori', null, null];
	private $_column_search = [null, 'a.judul', 'nama_kategori', null, null];
	...
	private function _query()
	{
		// Query
		$q =
			"SELECT a.id, a.uuid, a.judul, a.slug, a.konten,
			...
			CASE
				...
				THEN 'badge-success deactivate-halaman'
				ELSE 'badge-danger activate-halaman'
		...
		foreach ($result['data'] as  $k => $v) {
			...
			$row['aksi'] = "
				<div role=\"group\" class=\"btn-group btn-group-sm\">
					...
					</button>" : "") . (is_allowed('delete-halaman') ? " 
