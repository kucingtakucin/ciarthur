...
class Datatable extends CI_Model
{
	...
	private $_column_order = [null, null, 'a.judul', 'nama_kategori', null, null];
	private $_column_search = [null, null, 'a.judul', 'nama_kategori', null, null];
	...
	private function _query()
	{
		...
		$q =
			...
			a.is_published, a.created_at, a.created_by, a.is_published,
			...
			CASE
				...
				THEN 'badge-success deactivate-berita'
				ELSE 'badge-danger activate-berita'
		...
		foreach ($result['data'] as  $k => $v) {
			...
			$row['aksi'] = "
				<div role=\"group\" class=\"btn-group btn-group-sm\">
					...
					</button>" : "") . (is_allowed('delete-berita') ? " 
